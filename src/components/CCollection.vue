...
import aboutImage3 from "@/assets/images/abouts/about3.webp";
...
const products = [
  ...
  {
    id: 3,
    name: 'Perruque à cheveux courts',
  ...
  {
    id: 4,
    name: 'Cheveux humains noirs de jais',
    description: 'Work from home accessories',
  ...
  {
    id: 5,
    name: 'Perruque de cheveux raides',
    description: 'Journals and note-taking',
...
<template>
  <div class="grid grid-cols-2 min-h-screen p-24 bg-[#B2C0B0]/10">

    <div class="flex flex-col justify-center items-center">
      <h1 class="text-4xl text-center font-bold">Meilleure collection</h1>
      <p class="max-w-md text-center mb-8">Perruques synthétiques, mélangées et pré-bouclées de style naturel et perruques douces au toucher</p>
