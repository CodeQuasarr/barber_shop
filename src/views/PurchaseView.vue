        ...
        <div v-if="product && Object.entries(product).length" class="pt-6">
                ...
                <ol class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8" role="list">
                    <li>
                        <div class="flex items-center">
                            <RouterLink class="mr-2 text-sm font-medium text-gray-900" to="/products"> retour
                            </RouterLink>
                        </div>
                    </li>
                </ol>
            ...
            <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                ...
                <div class="aspect-h-5 aspect-w-4 lg:aspect-h-2 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
                    <img :alt="product.images[1].alt" :src="product.images[1].src"
                         class="h-full w-full object-cover object-center"/>
                </div>
            </div>
                ...
                <div class="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="mt-10">
                            ...
                            <p class="mt-4">
                                Découvrez notre perruque de cheveux noirs, alliant confort optimal et cheveux de haute
                                qualité. Profitez
                                d'une facilité d'entretien sans pareil et d'une allure élégante qui s'adapte à toutes
                                vos envies.
                            </p>
                        </div>
                        <button
